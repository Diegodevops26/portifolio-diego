...
function HeroDiagram() {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Diagrama de arquitetura: Diego Santos conectado às suas áreas de atuação"
    >
      <defs>
        <pattern
          id="grid"
      ...
      {nodes.map((n, i) => {
        ...
        return (
          <path
            key={n.key}
            d={`M ${cx + 78} ${cy} C ${midX} ${cy}, ${midX} ${n.y}, ${
              n.x - 4
            } ${n.y}`}
            fill="none"
            stroke="#5EEAD4"
      ...
      {nodes.map((n, i) => (
        <g
          ...
          style={{
            ...
            transition: `opacity 0.5s ease ${
              0.15 * i + 0.55
            }s, transform 0.5s ease ${0.15 * i + 0.55}s`,
          }}
        >
          <rect
            x={n.x}
...
const EXPERIENCE = [
  ...
  },
  {
    ...
    scope: "feat(fluxozen)",
    title:
      "Desenvolvedor Full Stack (Projeto Próprio) — FluxoZen Financeiro",
    org: "Projeto próprio",
    body:
...
const PROJECTS = [
  {
    ...
    desc:
      "Sistema de gestão completo para uma cooperativa de catadores de recicláveis em Teófilo Otoni — projeto de extensão com parceiros institucionais como Sicoob Credivale e Sebrae.",
  },
  {
    ...
    desc:
      "Aplicação web de gestão financeira pessoal com SSR, dashboard interativo e categorização automática de despesas.",
  },
  {
    name: "Life Organizer",
    status: "DEPLOYED",
    ...
    desc:
      "SaaS de produtividade full-stack com autenticação, verificação de propriedade de dados, filtros de tarefas e sistema de notificações.",
  },
  {
    ...
    desc:
      "Fangame de adivinhação de palavras ambientado no universo Ordem Paranormal, com estética de terminal e mecânicas gamificadas.",
  },
];
...
export default function Portfolio() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          >
            ...
            diego
            <span style={{ color: "#8B95AB" }}>.dev</span>
          </button>
          ...
          >
            {menuOpen ? (
              <X size={22} color="#E7ECF5" />
            ) : (
              <Menu size={22} color="#E7ECF5" />
            )}
          </button>
        </div>
          ...
          >
            {navItems.map((n) => (
              <button
                key={n.id}
                onClick={() => scrollTo(n.id)}
                className="mono text-sm text-left"
                style={{ color: "#B7C0D1" }}
              >
                {n.label}
              </button>
      ...
      <section
        id="topo"
        className="max-w-6xl mx-auto px-5 sm:px-8 pt-32 pb-20 grid md:grid-cols-2 gap-10 items-center"
      >
        <div>
          <div
            className="mono text-xs sm:text-sm mb-5"
            style={{ color: "#5EEAD4" }}
          >
          ...
          <h1
            className="display font-bold leading-[1.05] mb-5"
            style={{
              color: "#E7ECF5",
          ...
          <p
            ...
            style={{ color: "#8B95AB" }}
          >
            Formado em Análise e Desenvolvimento de Sistemas pelo IFNMG.
            Do levantamento de requisitos à entrega em produção —
            construindo interfaces e sistemas com foco em boas práticas
            e acessibilidade.
          </p>
          ...
          <div className="flex items-center gap-5">
            <a
              href="https://github.com/Diegodevops26"
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub"
              style={{ color: "#8B95AB" }}
            ...
            <a
              href="https://linkedin.com/in/diegosousasantosdev"
              target="_blank"
              rel="noreferrer"
              aria-label="LinkedIn"
              style={{ color: "#8B95AB" }}
            ...
            <a
              href="mailto:sousadiego953@gmail.com"
              aria-label="Email"
              style={{ color: "#8B95AB" }}
            >
              <Mail size={19} />
      ...
      >
        ...
        <Reveal delay={0.05}>
          <div className="grid md:grid-cols-3 gap-8">
            <p
              className="md:col-span-2 text-base sm:text-lg leading-relaxed"
              style={{ color: "#B7C0D1" }}
            >
              Desenvolvedor Full Stack formado pelo{" "}
              <strong style={{ color: "#E7ECF5" }}>
                IFNMG
              </strong>{" "}
              em Análise e Desenvolvimento de Sistemas, com
              ...
              cidade, com disponibilidade total para horário
              comercial.
            </p>
            ...
            >
              ...
              {[
                ["formação", "IFNMG · concluído em 31/08/2026"],
                ...
                <div
                  key={k}
                  className="flex justify-between mono text-xs py-2"
                  style={{
                    borderTop:
      ...
      >
        ...
        <div className="space-y-4">
          {SKILL_LAYERS.map((layer, i) => (
            ...
            >
              <div
                className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 rounded-lg p-5"
                style={{
                  background: "#0F1729",
                  border:
                    "1px solid rgba(148,163,184,0.14)",
      ...
      >
        ...
        <div className="relative">
          <div
            className="absolute left-[9px] top-2 bottom-2 w-px hidden sm:block"
            style={{
              background:
            ...
            {EXPERIENCE.map((exp, i) => (
              ...
              >
                <div className="relative sm:pl-10">
                  ...
                  >
                    <div
                      className="flex flex-wrap items-center gap-x-3 gap-y-1 mono text-[11px] mb-3"
                      style={{ color: "#8B95AB" }}
                    >
                    ...
                    <h3
                      className="display font-semibold text-base sm:text-lg mb-1"
                      style={{ color: "#E7ECF5" }}
                    >
                      {exp.title}
                    </h3>
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {PROJECTS.map((p, i) => (
            ...
            >
              <div
                className="proj-card rounded-lg p-6 h-full"
                style={{
                  background: "#0F1729",
                  border:
                    "1px solid rgba(148,163,184,0.14)",
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3
                    className="display font-semibold text-lg"
                    style={{ color: "#E7ECF5" }}
                  >
                    {p.name}
                  </h3>
                  ...
                  <span
                    className="mono text-[10px] px-2 py-1 rounded flex items-center gap-1.5"
                    style={{
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 py-20 grid md:grid-cols-2 gap-10">
        <Reveal>
          ...
          >
            <h3
              className="display font-semibold text-base mb-1"
              style={{ color: "#E7ECF5" }}
            >
            ...
            <p
              ...
              style={{ color: "#8B95AB" }}
            >
              Formação concluída em Análise e Desenvolvimento
              de Sistemas.
            </p>
        ...
        <Reveal delay={0.08}>
          ...
          >
            ...
            <p
              className="mono text-xs mt-5 mb-3"
              style={{ color: "#5EEAD4" }}
            >
              hackathons
            </p>
      ...
      <section
        id="contato"
        className="max-w-6xl mx-auto px-5 sm:px-8 py-24"
      >
        <Reveal>
          <div
          ...
          >
            ...
            <p
              ...
              style={{ color: "#8B95AB" }}
            >
              Disponível para vagas remotas, presenciais ou com
              mudança de cidade. Resposta rápida por e-mail ou
              WhatsApp.
            </p>
      ...
      <footer
        className="text-center py-8 mono text-[11px] flex items-center justify-center gap-1"
        style={{ color: "#4B5568" }}
      >
        diego@portfolio:~$ echo &quot;obrigado pela visita&quot;{" "}
